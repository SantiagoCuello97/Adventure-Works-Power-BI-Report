...
## Data Source  
The dataset used for this project is derived from Microsoft's AdventureWorks sample databases, provided as part of the **Maven Analytics Power BI Desktop course**.
